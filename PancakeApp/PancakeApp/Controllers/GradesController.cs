...
namespace PancakeApp.Controllers
{
    public class GradesController : Controller
    {
        ...
        public GradesController(StudentRecordContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Prelim_Quiz1,Prelim_Quiz2,Prelim_Quiz3,Prelim_Assign1,Prelim_Assign2,Prelim_Assign3,Midterm_Quiz1,Midterm_Quiz2,Midterm_Quiz3,Midterm_Assign1,Midterm_Assign2,Midterm_Assign3,Prefinal_Quiz1,Prefinal_Quiz2,Prefinal_Quiz3,Prefinal_Assign1,Prefinal_Assign2,Prefinal_Assign3,Final_Quiz1,Final_Quiz2,Final_Quiz3,Final_Assign1,Final_Assign2,Final_Assign3,UserID")] Grade grade)
        {
            System.Diagnostics.Debug.WriteLine(grade.UserID);
            ...
            StudentsDropdownList(grade.UserID);
            return View(grade);
        }
        ...
        {
            var studentsQuery = from u in _context.User
                                orderby u.Id
                                select u;

            ViewBag.UserID = new SelectList(studentsQuery.AsNoTracking(), "Id", "FullName", selectedStudent);
        }
    }
}
